<?php
/**
 * Template for Featured Image by URL metabox.
 *
...
<div id="knawatfibu_metabox_content" >
	...
	<input id="knawatfibu_url" type="text" name="knawatfibu_url" placeholder="<?php esc_attr_e( 'Image URL', 'featured-image-by-url' ); ?>" value="<?php echo esc_url( $image_url ); ?>" />
	...
	<div >
		<span id="knawatfibu_noimg"><?php esc_attr_e( 'No image', 'featured-image-by-url' ); ?></span>
		<img id="knawatfibu_img" src="<?php echo esc_url( $image_url ); ?>" />
	</div>

	<a id="knawatfibu_remove" class="button" style="margin-top:4px;"><?php esc_attr_e( 'Remove Image', 'featured-image-by-url' ); ?></a>
</div>
